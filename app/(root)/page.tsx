...
const Home = () => {
  return (
    <div className="w-[1440px] h-[1967px] relative bg-[#181a20]">
      ...
      <div className="w-[500px] h-[479px] left-[41px] top-[916px] absolute text-white text-4xl font-bold font-['Inter']">
        2,500+ businesses funded and served
      </div>
      <div className="left-[41px] top-[1478px] absolute text-white text-4xl font-bold font-['Inter']">
        TOP 10 Companies
      </div>
