...
const ProgressBar = ({ percentage, dayLeft, fundingTarget }: ProgressBarProps) => {
    return (
        <div className="w-full min-w-[300px] max-w-[1000px] mx-8 mt-4 md:mx-20">
            ...
            <div className="w-full bg-gray-200 rounded-full dark:bg-gray-700">
                <div className="flex bg-yellow-400 h-6 text-sm font-medium text-black text-center p-0.5 leading-none rounded-full justify-center items-center" style={{ width: `${percentage}%` }}> {percentage}%</div>
            </div>
        </div>
    )
}
