...
//     onChange: (richText: string) => void;
// }) => {
//     console.log("pitch", pitch); // This will log the pitch value whenever the component renders
...
//         },
//         onUpdate({ editor }) {
//             onChange(editor.getHTML()); // Call the onChange function with the current HTML content
//         },
//     });
