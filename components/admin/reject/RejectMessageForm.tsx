...
const getRejectMessage = (type: string) => {
  if (type === "company") {
    return [
      {
        ...
        description:
          "The uploaded logo does not match the official company logo.",
      },
      {
        id: "message2",
        title: "Incorrect Banner",
        description: "The uploaded banner does not meet branding guidelines.",
      },
      {
        id: "message3",
        title: "Incorrect Company Name",
        description: "The company name is misspelled or incorrect.",
      },
      {
        id: "message4",
        title: "Incorrect Company Abbreviation",
        description: "The company abbreviation is incorrect.",
      },
      {
        id: "message5",
        title: "Inaccurate Company Description",
        description:
          "The description does not accurately represent the company profile.",
      },
      {
        id: "message6",
        title: "Incorrect Company Registration Number",
        description: "The registration number provided is incorrect.",
      },
      {
        id: "message7",
        title: "Inaccurate Pitch Information",
        description: "The pitch does not reflect the correct product details.",
      },
      {
        id: "message8",
        title: "Incorrect Data Room Documents",
        description: "The uploaded documents do not match the company profile.",
      },
    ];
    ...
    return [
      {
        id: "message1",
        title: "Incorrect Profile Image",
        description: "The uploaded profile image does not match the investor.",
      },
      {
        id: "message2",
        title: "Incorrect Name",
        description: "The name provided does not match the investor.",
      },
      {
        id: "message3",
        title: "Incorrect Nationality",
        description: "The Nationality provided is incorrect.",
      },
    ];
    ...
    return [
      {
        ...
        description:
          "Your current access level does not permit viewing this document.",
      },
      {
        id: "message2",
        title: "Confidential Document",
        description:
          "This document contains sensitive information and is restricted to approved investors only.",
      },
    ];
  }
  return [];
...
export function RejectMessageForm({
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    const checkedMessages = messages.filter(
      (message) => values.messages[message.id]
    );
    ...
    if (type === "company") {
      ...
      if (companyId !== undefined) {
        ...
        if (company) {
          await sendEmailDataroomRequestStatus(
            request,
            email ?? "",
            "rejected",
            checkedMessages,
